    ...
    async fn test_podcast_multivoice_studio() {
        ...
        let pipeline = PipelineDefinition {
            ...
            edges: vec![
                PipelineEdge {
                    id: "e1".to_string(),
                    from_node: "script".to_string(),
                    to_node: "parser".to_string(),
                    from_port: None,
                    to_port: None,
                },
                PipelineEdge {
                    id: "e2".to_string(),
                    from_node: "parser".to_string(),
                    to_node: "voices".to_string(),
                    from_port: None,
                    to_port: None,
                },
                PipelineEdge {
                    id: "e3".to_string(),
                    from_node: "voices".to_string(),
                    to_node: "synth".to_string(),
                    from_port: None,
                    to_port: None,
                },
